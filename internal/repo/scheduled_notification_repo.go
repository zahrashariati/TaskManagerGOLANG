...
// ScheduledNotificationRepository handles database operations for scheduled notifications
// Note: The ScheduledNotification model is now in models/ folder, not here
...
// // This method should be in models/ folder as a method on ScheduledNotification
// func (sn *models.ScheduledNotification) ConvertToEvent() models.TaskScheduledEvent {
// 	return models.TaskScheduledEvent{
// 		EventID:    sn.EventID,
